  ...
  return (
    <div>
      ...
      <Card className="overflow-hidden shadow-xl">
        <div className="grid md:grid-cols-2 gap-0 md:gap-0"> {/* Removed gap for seamless edge */}
          <div className="relative aspect-square md:aspect-[4/3]"> {/* Adjusted aspect ratio */}
            <Image
              src={product.imageUrl}
              alt={product.name}
              layout="fill"
              objectFit="cover"
              className="md:rounded-l-lg" // Ensure rounded corners are applied correctly
